    ...
    def run(self):
        ...
        def go_turn():
            ...
            if(f1Avr > 3):
                ...
                Steering(turnDeg)
                # delay(300)
            elif(f1Avr > 5 and l5Avr > 5):
                turnDeg = (f1Avr)+(l5Avr-10)
            ...
            # 왼쪽으로
                ...
                Steering(turnDeg)
                # delay(300)
            elif(f3Avr > 5 and r4Avr > 5):
                turnDeg = (-f3Avr)+(-r4Avr+10)
        ...
        while autoGo == True:
            ...
            if(sensor.CDS > 700 and cds_ok == False):
                ...
                while answer == False:
                    ...
                    if(text == "직진" or text == "직진 직진" or text == "직진 직진 직진"):
                        answer = True
                        text = "직진"
                    elif(text == "왼쪽" or text == "완쪽" or text == "왼쪽 왼쪽" or text == "왼쪽 왼쪽 왼쪽" or text == "왼 쪽"):
                        answer = True
                        text = "왼쪽"
                    elif(text == "reload"):
